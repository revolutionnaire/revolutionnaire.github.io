...
var Lenis = /*#__PURE__*/ function() {
    ...
    function Lenis() {
        ...
        touchMultiplier, touchMultiplier = _ref_touchMultiplier === void 0 ? 1 : _ref_touchMultiplier, _ref_wheelMultiplier = _ref.wheelMultiplier, wheelMultiplier = _ref_wheelMultiplier === void 0 ? 1 : _ref_wheelMultiplier, _ref_autoResize = _ref.autoResize, autoResize = _ref_autoResize === void 0 ? true : _ref_autoResize, prevent = _ref.prevent, virtualScroll = _ref.virtualScroll, _ref_overscroll = _ref.overscroll, overscroll = _ref_overscroll === void 0 ? true : _ref_overscroll, _ref_autoRaf = _ref.autoRaf, autoRaf = _ref_autoRaf === void 0 ? false : _ref_autoRaf, _ref_anchors = _ref.anchors, anchors = _ref_anchors === void 0 ? false : _ref_anchors, _ref___experimental__naiveDimensions = _ref.__experimental__naiveDimensions, __experimental__naiveDimensions = _ref___experimental__naiveDimensions === void 0 ? false : _ref___experimental__naiveDimensions;
   ...
   */ (0, _defineProperty._)(this, "animatedScroll", void 0);
        ...
        (0, _defineProperty._)(this, "onScrollEnd", function(e) {
            if (!(e instanceof CustomEvent)) {
                if (_this.isScrolling === "smooth" || _this.isScrolling === false) e.stopPropagation();
            }
        });
        (0, _defineProperty._)(this, "dispatchScrollendEvent", function() {
        ...
        (0, _defineProperty._)(this, "onClick", function(event) {
            var path = event.composedPath();
            var anchor = path.find(function(node) {
                var _node_getAttribute;
                return node instanceof HTMLAnchorElement && ((_node_getAttribute = node.getAttribute("href")) === null || _node_getAttribute === void 0 ? void 0 : _node_getAttribute.startsWith("#"));
            });
            if (anchor) {
                var id = anchor.getAttribute("href");
                if (id) {
                    var options = (0, _typeOf._)(_this.options.anchors) === "object" && _this.options.anchors ? _this.options.anchors : void 0;
                    _this.scrollTo(id, options);
                }
            }
        });
...
},{"@swc/helpers/_/_class_call_check":"cUvdT","@swc/helpers/_/_create_class":"aFUX5","@swc/helpers/_/_define_property":"2kM9N","@swc/helpers/_/_object_spread":"jFF3n","@swc/helpers/_/_to_consumable_array":"4hSnh","@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi","@swc/helpers/_/_type_of":"7dHw6"}],"cUvdT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "_", function() {
